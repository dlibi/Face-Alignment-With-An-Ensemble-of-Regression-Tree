...
# Function used to make PointCloud to points
...
# Function to calculate the method to transform into the mean shape
...
def get_gt_shapes(images):
    return np.array([image.landmarks['PTS'] for image in images])
